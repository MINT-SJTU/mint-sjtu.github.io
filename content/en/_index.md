...
#      filename: research_topic.jpg
    text: |
      ...
      赵波是上海交通大学人工智能学院副教授、博导、国家级青年人才、阿里巴巴集团具身智能访问学者。曾担任智源研究院（BAAI）数据智能研究中心负责人、首席研究员。曾获得爱丁堡大学博士学位和北京大学硕士学位。研究方向包括具身智能、多模态大模型和数据智能（DCAI）等。已发表包括 CVPR, ICLR, TPAMI, Nature, 等数十篇论文，其中7篇 Oral/Spotlight. 曾获 ICML 2022 杰出论文奖。主持多项国自然基金委科研项目。担任 NeurIPS'25/24和BMVC'24 领域主席，并于 ICCV'25, CVPR'24 和 ECCV'24 组织 Workshops.
